...
#define generationsNum 5000 // total number of generations
...
#define POSITION_THRESH 2.8e-9 // maximum posDiff convergence threshold (General/PostProcessing/individualDifference-4var.csv)

#define SPEED_THRESH 4.4e-8 // minimum velDiff convergence threshold (DART Baseline Trajectory, JHU APL) (a.u./s)
